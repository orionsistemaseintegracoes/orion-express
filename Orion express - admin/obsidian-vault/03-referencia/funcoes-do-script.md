...
| Função | Ação |
|--------|------|
| `abrirModalDetalhes(id)` | Abre modal com dados |
| `fecharModalDetalhes()` | Fecha modal |
| `imprimirComandaAtual()` | Imprime comanda da cozinha |
